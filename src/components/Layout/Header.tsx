...
export const Header = () => {
  ...
  return (
    ...
    className="burguer-menu lg:hidden cursor-pointer z-50 ">
      { menuOpen ? <Image src="/svgs/burger-menu-right-color.svg" alt="burger-menu-color" className={'burger-svg w-8 h-8'} width={32} height={32}/> : <img src={`/svgs/burger-${headerScroll ? "menu-white" : "menu-color"}.svg`} alt="burger-menu-color" className={'burger-svg w-8 h-8'}/> }
    </button>
